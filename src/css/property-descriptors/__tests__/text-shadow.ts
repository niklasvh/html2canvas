...
describe('property-descriptors', () => {
    describe('text-shadow', () => {
        ...
        it('1px 1px 2px pink', () => deepStrictEqual(textShadowParse('1px 1px 2px pink'), [
            {
        ...
        it('#fc0 1px 0 10px', () => deepStrictEqual(textShadowParse('#fc0 1px 0 10px'), [
            {
        ...
        it('5px 5px #558abb', () => deepStrictEqual(textShadowParse('5px 5px #558abb'), [
            {
        ...
        it('white 2px 5px', () => deepStrictEqual(textShadowParse('white 2px 5px'), [
            {
        ...
        it('white 2px 5px', () => deepStrictEqual(textShadowParse('5px 10px'), [
            {
        ...
        it('1px 1px 2px red, 0 0 1em blue, 0 0 2em blue', () => deepStrictEqual(textShadowParse('1px 1px 2px red, 0 0 1em blue, 0 0 2em blue'), [
            {
