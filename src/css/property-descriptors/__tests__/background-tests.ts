...
describe('property-descriptors', () => {
    describe('background-image', () => {
        ...
        it('url(test.jpg), url(test2.jpg)', () => deepStrictEqual(backgroundImageParse('url(test.jpg), url(test2.jpg)'), [
        ...
        it(`linear-gradient(to bottom, rgba(255,255,0,0.5), rgba(0,0,255,0.5)), url('https://html2canvas.hertzen.com')`,
            () => deepStrictEqual(backgroundImageParse(`linear-gradient(to bottom, rgba(255,255,0,0.5), rgba(0,0,255,0.5)), url('https://html2canvas.hertzen.com')`), [
                {
